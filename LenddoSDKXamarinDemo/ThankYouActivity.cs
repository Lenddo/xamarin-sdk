...
{
    [Activity(Label = "Thank You", MainLauncher = true, Icon = "@mipmap/icon")]
    public class ThankYouActivity : Activity, ILenddoEventListener
    {
        ...
        bool ILenddoEventListener.OnButtonClicked(FormDataCollector formData)
        {
            ...
            formData.PartnerScriptId = "5671d773aa961243c55ee6ad";
        ...
        private void startOnboardingSDK()
        {
            ...
            helper.Collector.PartnerScriptId = "5671d773aa961243c55ee6ad";
